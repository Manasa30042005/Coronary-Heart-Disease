...
education=st.selectbox("Education Level",[1,2,3,4],help='1=Primary School, 2=High School, 3=College, 4=graduation')
...
totChol = st.number_input("Total Cholesterol", 100, 700, 220 )
